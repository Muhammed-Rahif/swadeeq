    ...
    <IonPage>
      ...
      >
        <div className="prose">
          ...
          <p>
            Swadeeq is an Islamic app that aims to help Muslims stay consistent
            on their Deen and regenerate spiritually. It is a chatbot that
            provides helpful features, such as prayer times, Islamic rulings,
            reminders for dhikr and dua, and more. The app has a rich,
          ...
          <p className="mb-2">
            ...
            me money. <b>Why Donations?</b> I built this app for the sake of
            Allah. But...
            ...
            degree eduction I have to leave it because I can't focus degree and
            job at the same time, and eventually I have to quit the company and
            continue degree. (
            <small>
              <i>
                This is a separate discussion that why I chose the degree rather
                than choosing the job and continuing it, for that you can
                personally contact me because I can't say the reason publicly.
                For now I can basically say it is becuase of our social system.
              </i>
            </small>
            ...
            <p className="my-3">
              <small>
                Please note that my family is not financially well-off, and I am
                solely dependent on the generosity of kind-hearted individuals
                who wish to help me for the sake of Allah SWT. Any donations,
                small or large, will be greatly appreciated and will go a long
                way in helping me achieve my goals.
              </small>
            </p>
